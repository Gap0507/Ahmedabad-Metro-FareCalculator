...
const YOUTUBE_URL = 'https://www.youtube.com/@ahmedabad-metro-map';
    ...
    return (
        <section className="grid gap-2 border-t border-neutral-200 pt-3 dark:border-zinc-700 sm:pt-4" aria-label={t('creatorLinks')}>
            ...
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs font-semibold text-neutral-500 dark:text-zinc-400">
                ...
                <a className="underline-offset-4 hover:text-neutral-800 hover:underline dark:hover:text-zinc-100" href="/open-source-free-alternative-to-ahmedabad-metro-sarthi-app/">Open-source alternatives</a>
            </div>
