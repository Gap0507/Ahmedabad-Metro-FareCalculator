...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    ahmedabadMetro: 'Ahmedabad Metro',
    fare: 'Fare',
    ...
    routePng: 'Route PNG',
    shareRouteText: 'Ahmedabad Metro route from {{from}} to {{to}} with {{stops}} stops, {{time}} travel time, and ₹{{fare}} fare.',
  },
  hi: {
    language: 'भाषा',
    english: 'अंग्रेज़ी',
    ...
    ahmedabadMetro: 'अहमदाबाद मेट्रो',
    fare: 'किराया',
    ...
    routePng: 'रूट PNG',
    shareRouteText: '{{from}} से {{to}} तक अहमदाबाद मेट्रो रूट: {{stops}} स्टॉप, {{time}} यात्रा समय, और ₹{{fare}} किराया।',
  },
  mr: {
    language: 'भाषा',
    english: 'इंग्रजी',
    ...
    routePng: 'मार्ग PNG',
    shareRouteText: '{{from}} ते {{to}} अहमदाबाद मेट्रो मार्ग: {{stops}} थांबे, {{time}} प्रवास वेळ, आणि ₹{{fare}} भाडे.',
  },
  bn: {
    language: 'ভাষা',
    english: 'ইংরেজি',
